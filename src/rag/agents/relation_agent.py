...
_INTENT_SYSTEM = (
    ...
    "αφορά ΣΧΕΣΕΙΣ μεταξύ νόμων. Αυτό περιλαμβάνει και ρητά ρήματα σχέσης "
    "(τροποποιεί/καταργεί/αντικαθιστά/προστίθεται/αναφέρεται) ΑΛΛΑ ΚΑΙ γενικά/"
    "έμμεσα (επηρεάζει/σχετίζεται με/συνδέεται με/αφορά άλλους νόμους). "
...
- direction: καθορίζεται από τον ΓΡΑΜΜΑΤΙΚΟ ΡΟΛΟ του εστιακού νόμου:
              "outgoing" αν ο εστιακός νόμος είναι το ΥΠΟΚΕΙΜΕΝΟ που ενεργεί προς άλλους
                         (π.χ. "τι τροποποιεί/καταργεί ο ν. Χ", "σε ποιους νόμους αναφέρεται ο ν. Χ")
              "incoming"  αν ο εστιακός νόμος είναι το ΑΝΤΙΚΕΙΜΕΝΟ που το επηρέασαν άλλοι
                         (π.χ. "ποιοι τροποποίησαν/κατήργησαν τον ν. Χ", "ποιοι αναφέρθηκαν στον ν. Χ")
              "both"      αν η σχέση είναι ΑΜΟΙΒΑΙΑ/ΣΥΜΜΕΤΡΙΚΗ ή μη κατευθυντική
                         (σχετίζεται/συνδέεται/"τι σχέση έχει"/"με ποιους σχετίζεται"),
                         ή αν ρωτά ρητά και τις δύο κατευθύνσεις
...
- "Ποιοι νόμοι κατήργησαν τον ν. 4001/2011;" →
  {{"is_relational": true, "direction": "incoming",
    ...
    "relations": ["καταργεί"]}}
- "Ποιους νόμους επηρεάζει ο ν. 4878/2022;"  (γενικό/έμμεσο ρήμα, ο νόμος ενεργεί) →
  {{"is_relational": true, "direction": "outgoing",
    "source_law": {{"kind":"Ν.","number":4878,"year":2022}},
    "relations": null}}
- "Με ποιους νόμους συνδέεται ο ν. 3000/2010;"  (συμμετρικό/αμοιβαίο ρήμα σχέσης) →
  {{"is_relational": true, "direction": "both",
    "source_law": {{"kind":"Ν.","number":3000,"year":2010}},
    "relations": null}}
